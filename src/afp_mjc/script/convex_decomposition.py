...
filename = "/home/lgx/Project/AFP/src/afp_mjc/env/AFPhead/meshes/base_link.STL"
...
if save_confirm.lower() == 'y':
    for i, (verts, faces) in enumerate(parts):
        sub_mesh = trimesh.Trimesh(verts, faces)
        sub_mesh.export(f"/home/lgx/Project/AFP/src/afp_mjc/env/AFPhead/meshes/parts/AFPhead_part_{i}.STL")
    print("保存完成。")
